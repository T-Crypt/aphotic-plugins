...
// The anglerfish, drawn as vector paths off the live palette so it
// retints with the theme instead of sitting on the desktop as a foreign
// sprite. The plugin's original pet, and still the one the shell's own
// name is a joke about.
//
